...
public class FlowViewHorizontal extends View {
    ...
    private float bgRadius;    //背景圆半径
    private float proRadius;   //前景圆半径
    private float startX;      //直线部分的开始
    private float stopX;       //直接部分的结束
    private float bgCenterY;   //上下padding  减掉之后/2
    private int lineBgWidth;   //背景直线宽度
    private int bgColor;
    private int lineProWidth;  //前景直线宽度
    private int proColor;
    private int textPadding;
    private int timePadding;
    private int maxStep;       //最大步骤
    ...
    public FlowViewHorizontal(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        proColor = ta.getColor(R.styleable.FlowViewHorizontal_h_pro_color, Color.GREEN);
