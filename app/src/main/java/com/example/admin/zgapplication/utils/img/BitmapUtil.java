package com.example.admin.zgapplication.utils.img;
...
public final class BitmapUtil {
    ...
    /**
     * 根据Drawable获取指定大小的Bitmap
     *
     * @param drawable Drawable
     * @return Bitmap
     */
    public static Bitmap getBitmapFromDrawableWithWH(Drawable drawable, int width, int height) {
