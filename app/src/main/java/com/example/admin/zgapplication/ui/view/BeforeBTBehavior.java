 ...
 * a bottom sheet.
 */
public class BeforeBTBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
     ...
     */
    public BeforeBTBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//        a.recycle();
    ...
    /**
     * A utility function to get the {@link BeforeBTBehavior} associated with the {@code view}.
     *
     * @param view The {@link View} with {@link BeforeBTBehavior}.
     * @return The {@link BeforeBTBehavior} associated with the {@code view}.
     */
    @SuppressWarnings("unchecked")
    public static <V extends View> BeforeBTBehavior<V> from(V view) {
        ...
        CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.LayoutParams) params)
                .getBehavior();
        if (!(behavior instanceof BeforeBTBehavior)) {
            throw new IllegalArgumentException(
                    "The view is not associated with BottomSheetBehavior");
        }
        return (BeforeBTBehavior<V>) behavior;
    }
